...
import Dot from '../../Component/FormComponent/Dot';
...
export default function Order() {
  ...
  return (
    <div className="order_main">
      ...
      {books.map((book, idx )=> (
        <div className="order_cards d-flex justify-content-between flex-wrap justify-content-sm-between gap-4 mb-3">
